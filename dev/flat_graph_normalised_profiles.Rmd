---
title: "flat_graph_normalised_profiles.Rmd empty"
...
```{r development-graph_normalised_profiles}
# Prepare the code of your function here
```

```{r function-graph_normalised_profiles}
...
```{r examples-graph_normalised_profiles}
graph_normalised_profiles()
```

```{r tests-graph_normalised_profiles}
...
fusen::inflate(flat_file = "dev/flat_graph_normalised_profiles.Rmd", vignette_name = NA)
```
