...
soles_and_benthos_contam$grp <- factor(soles_and_benthos_contam$grp, levels = c("G0", "Bivalves", "Polychetes", "Crustaces"))
```
...
p2 = graph_grp(data = soles_and_benthos_contam, grp = "grp", variable = "sommePFCA_ng_gdw", label_data = "soles et benthos", label_y=expression(paste(sum(),"PFCA")), title = expression(paste(sum(),"PFCA")))
p3 = graph_grp(data = soles_and_benthos_contam, grp = "grp", variable = "sommePFSA_ng_gdw", label_data = "soles et benthos", label_y=expression(paste(sum(),"PFSA")), title = expression(paste(sum(),"PFSA")))
p4 = graph_grp(data = soles_and_benthos_contam, grp = "grp", variable = "sommeFOSA_ng_gdw", label_data = "soles et benthos", label_y=expression(paste(sum(),"FOSA et FOSAA")), title = expression(paste(sum(),"FOSA et FOSAA")))
p5 = graph_grp(data = soles_and_benthos_contam, grp = "grp", variable = "sommeHBCDD_ng_gdw", label_data = "soles et benthos", label_y=expression(paste(sum(),"HBCDD")), title = expression(paste(sum(),"HBCDD")))
