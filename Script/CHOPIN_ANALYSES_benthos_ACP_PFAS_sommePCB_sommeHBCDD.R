...
colnames(ACP_benthos) = c("esp.","%lip","zone","grp","saison","alim.","sommePCB", PFAS_selected_benthos,"sommeHBCDD")
colnames(ACP_benthos)[c(16,17)] = c("L-PFOS","6:2-FTSA")
