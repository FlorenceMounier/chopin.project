...
benthos_contam = read.xlsx(path_CHOPIN_BDD,
                           sheet = "benthos")
...
# --------------------------------------------------------------
# Calcul des sommes par famille en ng_g.1ps
...
benthos_contam$sommePFCA_ng_gdw = apply(benthos_contam[,PFCA], MARGIN = 1, FUN = sum)
benthos_contam$sommeFOSA_ng_gdw = apply(benthos_contam[,FOSAs], MARGIN = 1, FUN = sum)
benthos_contam$sommePFSA_ng_gdw = apply(benthos_contam[,PFSA], MARGIN = 1, FUN = sum)
...
# Concentrations normalisees par la somme pour les PCB
  ...
  benthos_contam[,paste(PFAS,"normalised_sum_ng.gdw",sep="_")] = benthos_contam[,PFAS]/benthos_contam$sommePFAS_ng_gdw

  benthos_contam[,paste(HBCDD,"normalised_sum_ng.gdw",sep="_")] = benthos_contam[,paste(HBCDD,"_ng_g.1ps_censored",sep="")]/benthos_contam$sommeHBCDD_ng_gdw
