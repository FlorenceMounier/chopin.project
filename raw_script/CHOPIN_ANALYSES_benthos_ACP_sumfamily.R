...
ACP_benthos = benthos_contam[,c("species","lip_PS_percent","zone","grp","season","alim",
                                "sommePCB_ng_gdw",
                                "sommePFAS_ng_gdw","sommeHBCDD_ng_gdw")]
...
colnames(ACP_benthos) = c("esp.","%lip","zone","grp","saison","alim.","sommePCB", "sommePFAS","sommeHBCDD")
...
png(filename = "Output/BENTHOS/BENTHOS_acp_sum_contrib_axes.png",
...
png(filename = "Output/BENTHOS/BENTHOS_acp_sum_var.png",
...
png(filename = "Output/BENTHOS/BENTHOS_acp_sum_ind.png",
